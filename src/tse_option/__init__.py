...
def download(symbols, j_date=False, start=None, end=None, adjust_price=False, drop_unadjusted=False):
    ...
    for symbol in symbols:
        ...
        df = df.rename(
            columns={"<OPEN>": "Yesterday", "<CLOSE>": "Close", "<FIRST>": "Open", "<HIGH>": "High", "<LOW>": "Low",
                     "<VOL>": "Volume"})
...
def option_chain(symbol: str, trading_days: int = 100, IV=False, leverage=True, P_BSM=False, sort="Maturity", rf=0.3):
    """
